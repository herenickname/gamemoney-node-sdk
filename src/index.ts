...
export type GetCardSessionStatusRequest = Record<string, any> & ({ invoice: string } | { project_invoice: string })
...
export type GetCardSessionStatusResponse = WaitOrDeclineCardSessionStatusResponse | FinishCardSessionStatusResponse
...
export type InvoiceStatus = 'New' | 'Processing' | 'Paid' | 'Chargeback' | 'Refund' | 'Chargeback_cancel' | 'Refused'
...
export default class GameMoney {
    private readonly axios = axios.create({
        baseURL: 'https://paygate.gamemoney.com/',
        responseType: 'json'
    })
    ...
    public async request<T extends GenericResponse>(
        ...
        if (signType === SignType.RSA) {
            if (!this.config.rsaPrivateKey) {
                throw new Error("To make requests with RSA sign type, 'rsaPrivateKey' must be provided")
            }
        ...
        const { data: response } = await this.axios.postForm<T>(url, form)
    ...
    public async createInvoice(body: CreateInvoiceRequest) {
        return this.request<CreateInvoiceResponse & GenericResponse>('invoice/', body)
    }
    ...
    public async getInvoiceStatus(body: GetInvoiceStatusRequest) {
        return this.request<GetInvoiceStatusResponse & GenericResponse>('invoice/status', body)
    }
    ...
    public async getInvoiceList(body: GetInvoiceListRequest) {
        return this.request<GetInvoiceListResponse & GenericResponse>('invoice/list', body)
    }
    ...
    public async getCheckoutStatus(body: GetCheckoutStatusRequest) {
        return this.request<GetCheckoutStatusResponse & GenericResponse>('checkout/status', body)
    }
    ...
    public async getCheckoutList(body: GetCheckoutListRequest) {
        return this.request<GetCheckoutListResponse & GenericResponse>('checkout/list', body)
    }
    ...
    public async addTokenCard(body: AddTokenCardRequest) {
        return this.request<AddTokenCardResponse & GenericResponse>('card/addtoken', body)
    }
    ...
    public async getCardList(body: GetCardListRequest) {
        return this.request<GetCardListResponse & GenericResponse>('card/list', body)
    }
    ...
    public async getCardFullList(body: GetCardFullListRequest) {
        return this.request<GetCardFullListResponse & GenericResponse>('card/fulllist', body)
    }
    ...
    public async prepareExchange(body: PrepareExchangeRequest) {
        return this.request<PrepareExchangeResponse & GenericResponse>('exchange/prepare', body)
    }
    ...
    public async fastConvertExchange(body: FastConvertExchangeRequest) {
        return this.request<FastConvertExchangeResponse & GenericResponse>('exchange/fastconvert', body)
    }
    ...
    public async getExchangeRate(body: GetExchangeRateRequest) {
        return this.request<GetExchangeRateResponse & GenericResponse>('exchange/rate', body)
    }
    ...
    public async getExchangeInfo(body: GetExchangeInfoRequest) {
        return this.request<GetExchangeInfoResponse & GenericResponse>('exchange/info', body)
    }
    ...
    public async getExchangeStatus(body: GetExchangeStatusRequest) {
        return this.request<GetExchangeStatusResponse & GenericResponse>('exchange/status', body)
    }
    ...
    public async getBalanceStatistics(body: GetBalanceStatisticsRequest) {
        return this.request<GetBalanceStatisticsResponse & GenericResponse>('statistics/balance', body)
    }
    ...
    public async getDaysBalanceStatistics(body: GetDaysBalanceStatisticsRequest) {
        return this.request<GetDaysBalanceStatisticsResponse & GenericResponse>('statistics/days_balance_project', body)
    }
    ...
    public async getPayTypesStatistics() {
        return this.request<GetPayTypesStatisticsResponse & GenericResponse>('statistics/paytypes')
    }
    ...
    public async createTerminal(body: CreateTerminalRequest) {
        return this.request<CreateTerminalResponse & GenericResponse>('terminal/create', body)
    }
}
